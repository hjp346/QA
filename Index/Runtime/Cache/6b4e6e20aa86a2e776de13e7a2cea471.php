...
<li>  <a href="<?php echo U('Member/myask',array('id'=>$user['id']));?>">他的提问</a></li>
<li style="background-color:#EEEEEE"> <a href="<?php echo U('Member/myanswer',array('id'=>$user['id']));?>">他的回答</a></li>
</ul>
</div>
    ...
    <div class="span9">
      <!--Body content-->
       ...
       <table class='table table-bordered'>
        ...
        <tr style="background-color:#DFF0DB"><td width="400">回答过的问题</td><td>回答数</td><td>时间</td></tr>
