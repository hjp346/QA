...
<a href=''><h5><i class="icon-user"></i> <?php echo ($msg["username"]); ?></h5></a>
...
<li style="background-color:#EEEEEE"> <a href="<?php echo U('Member/index',array('id'=>$msg['id']));?>">他的首页</a></li>
<li> <a href="<?php echo U('Member/myask',array('id'=>$msg['id']));?>">他的提问</a></li>
<li> <a href="<?php echo U('Member/myanswer',array('id'=>$msg['id']));?>">他的回答</a></li>
</ul>
    ...
    <div class="span9">
      <!--Body content-->
       ...
       <table class='table table-bordered'>
        ...
        <tr   style="background-color:#DFF0DB"><td>金币</td><td>经验值</td><td>回答数</td><td>提问数</td></tr>
        <tr><td><?php echo ($msg["money"]); ?></td><td><?php echo ($msg["experience"]); ?></td><td><?php echo ($msg["answer"]); ?></td><td><?php echo ($msg["ask"]); ?></td></tr>
